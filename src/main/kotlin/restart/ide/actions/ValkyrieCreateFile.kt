...
class ValkyrieCreateFile :
    ...
    companion object {
        private val name = restart.ValkyrieBundle.message("action.create_file")
        private val description = restart.ValkyrieBundle.message("action.create_file.description")
