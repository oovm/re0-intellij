...
import restart.language.mixin.MixinEvent;
import restart.language.psi.*;
import restart.language.ast.ASTMethods;

public class RestartEventStatementNode extends MixinEvent implements RestartEventStatement {

  public RestartEventStatementNode(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public RestartKwEvent getKwEvent() {
    return findNotNullChildByClass(RestartKwEvent.class);
  }
